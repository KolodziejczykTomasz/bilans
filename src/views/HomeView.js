      ...
      <div class="jumbotron">
        <div class="jumboHeroTextWrapper">
          <div class="jumboHeroTextWrapperTextHero">
            <h1 class="jumboHeroTextWrapperTextHeroH1">
              Wyznaczamy dobry kierunek
            </h1>
          </div>
          ...
          <div class="jumboHeroTextWrapperSubtitle">
            <p class="jumboHeroTextWrapperSubtitleLine">
              Lidzbark Warmiński | Dobre Miasto
            </p>
          </div>
        </div>
      </div>
        ...
        <div class="bg-white rounded about">
          <Container fluid data-aos="fade-up">
            <Row>
              <Col>
                <p id="aboutFirst">
                  Jesteśmy biurem rachunkowym z Lidzbarka Warmińskiego z filią w
                  Dobrym Mieście. Specjalizujemy się w świadczeniu kompleksowych
                  usług księgowych w zakresie doradztwa finansowego,
                  podatkowego, księgowego oraz dotacyjnego.
                </p>
              </Col>
            </Row>
            <Row>
            ...
            <Row>
              <Col>
                <p id="aboutSecond">
                  Nasze biuro rachunkowe chce dla swoich klientów być partnerem
                  na najwyższym poziomie, a nie biurem rachunkowym do
                  wprowadzania dokumentów księgowych. Staramy się być dla
                  naszych klientów kimś, komu warto powierzyć swoje finanse. Wieloletnie doświadczenie
                  pozwala precyzyjnie i rzetelnie doradzać naszym Klientom nie
                  tylko w zakresie księgowości, ale także finansów, podatków i
                  kadr, aby wybrać najlepsze rozwiązanie dopasowane w 100% do
                  ich potrzeb.
                </p>
              </Col>
            </Row>
          ...
          <Container data-aos="fade-up">
            <Row>
              <Col sm="12" md="6" lg="4" id="servicesCol">
                ...
                działalności gospodarczej, którzy również mogą przez nasze Biuro
                służyć pomocą w sprawach związanych z zakresu BHP, obsługi
                prawnej oraz wszelkiego rodzaju ubezpieczeń.
              </Col>
              <Col sm="12" md="6" lg="4" id="servicesCol">
                <p id="serviceColHeader">
                  <FaCheck id="checkIcon" />
                ...
                rozwiązujemy profesjonalnie i najszybciej jak tylko to możliwe.
              </Col>
              <Col sm="12" md="6" lg="4" id="servicesCol">
                <p id="serviceColHeader">
                  <FaCheck id="checkIcon" />
                ...
                Warmińskim przy ulicy Poniatowegiego 18, ale zapraszamy również
                do naszej filii w Dobry Mieście przy ulicy Jana Pawła II 25.
              </Col>
            </Row>
            <Row id="servicesSecondLine">
              <Col sm="12" md="6" lg="4" id="servicesCol">
                ...
                podzielić – dla wszystkich zainteresowanych zapraszamy na profil
                społecznościowy.
              </Col>
              <Col sm="12" md="6" lg="4" id="servicesCol">
                <p id="serviceColHeader">
                ...
                potrzebujesz profesjonalnej pomocy przy sporządzeniu wniosku do
                Urzędu Pracy w swojej miejscowości lub innej? Pomożemy napisać
                profesjonalny i kompleksowy wniosek na pozyskanie środków na
      ...
      <Container fluid="md">
        <Row>
          <Col>
            <p id="copyright">
              &copy; 2021
              <span class="footerCopyrightSpan">Biuro Rachunkowe Bilans</span>
            </p>
          </Col>
        </Row>
      </Container>
